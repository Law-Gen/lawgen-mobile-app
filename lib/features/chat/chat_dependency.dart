...
Future<void> setupChatFeatureDependencies() async {
  ...
  if (!chatsl.isRegistered<InternetConnectionChecker>()) {
    // Using named constructor to accommodate versions without default ctor
    chatsl.registerLazySingleton<InternetConnectionChecker>(
